            ...
            <div class="row mb-3">
                ...
                <div class="col-auto">
                    ...
                    <form action="/html/reservationBook.php" method="get">
                        ...
                        <input type="hidden" name="pickupLocationId" value="<?php echo $_GET['pickupLocation'] ?>">
                        ...
                        <input type="hidden" name="dropoffLocationId" value="<?php echo $_GET['dropoffLocation'] ?>">
