<form action="" method="post">
    ...
    <div class="d-flex justify-content-center">
        ...
        <input type="hidden" name="pickupLocation" value="<?php echo $_GET['pickupLocationId'] ?>">
        ...
        <input type="hidden" name="dropoffLocation" value="<?php echo $_GET['dropoffLocationId'] ?>">
