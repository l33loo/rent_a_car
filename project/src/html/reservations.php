        ...
        <div class="card mb-3">
            <div class="row g-0">
                <div class="col-md-4" style="overflow: hidden;">
                    <img src="/src/img/car.jpg" class="img-fluid rounded-start" alt=""
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        <h2 class="card-title">
                            ...
                            <small>(<?php echo $category->getName() ?>)</small>
                        </h2>
                        <div>
                            <?php foreach ($categoryProperties as $categoryProperty) { ?>
                            <span
                                class="p-1 m-1 bg-warning-subtle"><?php echo $categoryProperty->getName() . ': ' . $categoryProperty->getPropertyValue() ?></span>
                            <?php } ?>
                        </div>
